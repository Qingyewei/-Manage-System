  ...
  <div>
    <el-card>
      ...
      <el-table :data="userList" border stripe>
        ...
        <el-table-column header-align="center" align="center" prop="username" label="姓名"></el-table-column>
        ...
        <el-table-column header-align="center" align="center" prop="role_name" label="角色"></el-table-column>
        ...
        <el-table-column header-align="center" align="center" width="180px" label="操作">
          <template slot-scope="scope">
            <el-button icon="el-icon-edit" size="mini" @click="showEditDialog(scope.row.id)"></el-button>
            <el-button icon="el-icon-delete" size="mini" @click="removeUserById(scope.row.id)"></el-button>
    ...
    <!-- 修改用户的对话框 -->
    <el-dialog v-dialogDrag title="修改用户" :visible.sync="editDialogVisible" width="50%" @close="editDialogClosed">
  ...
  methods: {
    async getUserList() {
      ...
      if (res.meta.status !== 200) {
        return this.$message.error("获取角色名单失败！");
      }
